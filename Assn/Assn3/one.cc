...
//  Test top
void helper_test_1( pq_one<char> pq)
{
    cout << "\ntop is: " << pq.top() << endl << endl; 
}

void helper_test_2( pq_one<char> pq)
{
...
void helper_test_3( pq_one<char> pq)
{
...
void test_1()
{
    ...
    pq_one<char> pq (letters, numbers);
    pq.print();
